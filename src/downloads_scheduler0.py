...
class DownloaderI(Downloader.SyncEvent,Downloader.DownloadScheduler):
    ''' Servant del Downloader'''
    def __init__(self, name, syncevent_publisher=None, publisher_progresstopic=None):
        ''' Constructor '''
        self.name = name
        self.song_list = set([])
        self.syncevent_publisher = syncevent_publisher
        self.syncevent_publisher.requestSync()
        ...
        self.syncevent_publisher.notify(["cancion1","cancion2"])
    ...
    def notify(self, songs, current=None):
        ...
        todas las canciones de los servidores
         '''
        print("Funciona notify")
        self.song_list = self.song_list.union(set(songs))
    ...
    def requestSync(self, current=None):
        ...
        '''
        print("Funciona requestSync")
        self.syncevent_publisher.notify(list(self.song_list))
